...
@section('content')
    ...
    <div class="relative min-h-screen block md:flex items-center overflow-hidden">
        ...
        <div class="relative md:absolute inset-0 flex">
            ...
            <div class="hidden md:block md:w-3/5 bg-[#3B0014]"></div>
            <!-- Right side - Image -->
            <div class="block w-full md:w-2/5 bg-gray-400">
                <img 
                src="{{ $banner?->image 
        ...
        <div class="relative z-10 mx-auto px-6 lg:px-20 py-12 md:py-32 w-full bg-[#3B0014] md:bg-transparent">
            <div class="md:w-3/5">
                ...
                <div class="flex flex-wrap gap-4 animate-fade-up animate-delay-2">
    ...
    @php
        $stats = $statistics->count() > 0
            ? $statistics
            : collect([
                (object)['angka' => 10, 'description' => 'Years of experience'],
                (object)['angka' => 500, 'description' => 'Clients advised'],
                (object)['angka' => 20, 'description' => 'Nationalities supported'],
                (object)['angka' => 1000, 'description' => 'Legal matters handled'],
            ]);
    @endphp
        ...
        x-data="{
            ...
            startCounting() {
                ...
                const animate = (currentTime) => {
                    ...
                    @foreach($stats as $index => $stat)
                    this.count{{ $index }} = Math.round(targets.count{{ $index }} * easeProgress);
                    @endforeach
    ...
    >
        <div class="mx-auto px-6 lg:px-20">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-{{ min($stats->count(), 4) }} gap-8">
                
                @foreach($stats as $index => $stat)
                <div class="text-center md:text-left {{ !$loop->last ? 'border-r border-[rgba(255,255,255,0.1)]' : '' }}">
                    <div class="text-white">
                        <h3 class="text-[#f5f5f5] font-semibold text-[48px] mb-[13px] animate-fade-up">
                            <span x-text="count{{ $index }}"></span>+
                        </h3>

                        <div class="text-[rgba(255,255,255,0.6)] text-lg font-medium animate-fade-up animate-delay-1">
                            {{ $stat->description }}
                        </div>
                    </div>
                </div>
    ...
    <div class="relative pt-[60px] md:pt-[160px] pb-[60px] md:pb-[120px] mt-[-12px] bg-[#6C342C] rounded-b-[16px] z-[2]">
        ...
        <div class="relative z-10 mx-auto px-6 lg:px-20">
            <div class="flex flex-wrap items-end mb-[60px]">
                <div class="basis-full lg:basis-1/2 mb-5 md:mb-0">
                    <p class="title text-[#F1ECEC] text-base font-medium mb-2">{{ $whyWorkSettings->title ?? 'Why work with us' }}</p>
                    <h2 class="text-[#f5f5f5] text-[36px] md:text-[52px] font-medium leading-[110%]">{!! $whyWorkSettings->subtitle ?? 'Trusted guidance, <br>  from start to finish' !!}</h2>
                </div>
    ...
    <div class="mt-[-16px] pt-[80px] md:pt-[160px] pb-[40px] md:pb-[80px] bg-[#410014] relative z-[1]">
        <div class="relative z-10 mx-auto px-6 lg:px-20">
            <div class="flex flex-wrap items-end mb-7 md:mb-[60px]">
                <div class="basis-full lg:basis-1/2">
    ...
    <div class="relative pt-[120px] md:pt-[180px] pb-[80px] md:pb-[130px] mt-[-12px] bg-[#6C342C]">
        <div class="absolute top-0 left-0 bottom-0 right-0 transform rotate-180" style="background: linear-gradient(180deg, #944229 13.02%, rgba(108, 52, 44, 0) 100%), #3B0014;"></div>
        <div class="relative z-10 mx-auto px-6 lg:px-20">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div class="mt-[-50px]">
                    ...
                    @else
                    <h3 class="text-[#D9D9D9] text-[44px] md:text-[52px] leading-[120%] font-medium">Your questions,</h3>
                    <h4 class="text-[#F1AE43] text-[44px] md:text-[52px] leading-[120%] font-medium">answered</h4>
                    @endif
                </div>
                ...
                <div class="space-y-2" x-data="{ active: null }">
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-lg overflow-hidden transition-all duration-300">
                        <button 
                            ...
                            class="w-full px-4 py-3 md:px-6 md:py-5 flex items-center justify-between text-left text-white hover:bg-white/5 transition-colors"
                        >
