...
@section('title', 'Tambah Kategori Client Journey')
...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form action="{{ route('cms.client-journey.categories.store') }}" novalidate method="POST">
        @csrf
        ...
        <div class="mb-4">
            <label for="slug" class="block text-sm font-medium text-gray-700 mb-2">Slug (otomatis jika kosong)</label>
