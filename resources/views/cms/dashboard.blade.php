...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 text-sm font-medium">About Us Team</p>
                    <p class="text-3xl font-bold text-gray-800 mt-2">{{ \App\Models\AboutUsTeamMember::count() }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="{{ route('cms.banners.create') }}"
                    class="flex items-center justify-center p-4 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition">
                ...
                <a href="{{ route('cms.services.create') }}"
                    class="flex items-center justify-center p-4 border-2 border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition">
                    <i class="fas fa-plus text-gray-600 mr-2"></i>
                    <span class="font-medium text-gray-700">Add Service</span>
                </a>
                <a href="{{ route('cms.testimonials.create') }}"
                    class="flex items-center justify-center p-4 border-2 border-gray-200 rounded-lg hover:border-yellow-500 hover:bg-yellow-50 transition">
                    <i class="fas fa-plus text-gray-600 mr-2"></i>
