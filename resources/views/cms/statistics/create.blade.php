...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form action="{{ route('cms.statistics.store') }}" novalidate method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="angka" id="angka" value="{{ old('angka') }}" required placeholder="contoh: 10+"
            ...
            <p class="text-sm text-gray-500 mt-1">Format bebas, contoh: 10+, 500+, 1000+</p>
        </div>

        <div class="mb-4">
            <label for="description" class="block text-sm font-medium text-gray-700 mb-2">Description <span class="text-red-500">*</span></label>
            <textarea name="description" id="description" rows="3" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3B0014] focus:border-transparent">{{ old('description') }}</textarea>
        </div>
